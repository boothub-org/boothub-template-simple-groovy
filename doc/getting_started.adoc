...
http://boothub.org/app#/home/true/https%3A%2F%2Fgithub.com%2Fboothub-org%2Fboothub-template-simple-groovy%2Freleases%2Fdownload%2Fv{project-version}%2Fsimple-groovy-{project-version}.zip[BootHub GUI, role="external", window="_blank"]
or the
